...
PROJECT_NAME ?= provider-opensearch
...
REGISTRY_ORGS ?= xpkg.upbound.io/tages
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= xpkg.upbound.io/tages
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= xpkg.upbound.io/tages
XPKGS = $(PROJECT_NAME)
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/opensearch.upjets/01-delete.yaml.tmpl.
