...
func (mg *Detection) GetTerraformResourceType() string {
	return "opensearch_anomaly_detection"
}
...
// GetID returns ID of underlying Terraform resource of this Detection
...
// LateInitialize this Detection using its observed tfState.
