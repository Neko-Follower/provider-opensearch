module github.com/tagesjump/provider-opensearch

go 1.24.11


replace github.com/opensearch-project/terraform-provider-opensearch v0.0.0 => github.com/opensearch-project/terraform-provider-opensearch/v2 v2.2.1
...
require (
	...
	github.com/opensearch-project/terraform-provider-opensearch v0.0.0
